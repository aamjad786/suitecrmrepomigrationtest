...
'                                   <span id="move_to_bcc_span{idx}" style="padding-left:9px"><a href="#" onclick="SE.composeLayout.moveToBCC(\'move_to_bcc\',\'{idx}\');">{mod_strings.LBL_MOVE_TO_BCC}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="AddToEmailId" href="#" onclick="SE.composeLayout.addToEMail(\'move_to_bcc\',\'{idx}\');">{mod_strings.LBL_ADD_CUSTOMER_EMAIL}</a></span><br />'+
...
'							<td class="emailUIField" NOWRAP>' +
'								<div class="ac_autocomplete">' +
'									&nbsp;&nbsp;<input class="ac_input" type="text" size="96" id="addressBCC{idx}" name="addressBCC{idx}" title="{app_strings.LBL_EMAIL_BCC}" onkeyup="SE.composeLayout.showAddressDetails(this);" onload="SE.composeLayout.ccToBCC(\'move_to_bcc\',\'{idx}\');">' +

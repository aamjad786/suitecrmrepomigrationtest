...
class DataSync{
    ...
    // function CheckUpdatedFields1($bean, $event, $arguments){
    ...
    //         // require_once 'custom/CustomLogger/CustomLogger.php';
    //         // $this->logger=new CustomLogger('data_sync.log');
    //         // //$this->logger->log('debug', '$retrieved_data =====>'.print_r($retrieved_data));

    //         // //$myfile = fopen("Logs/data_sync.log",'a');
    //         // require_once 'modules/ACLRoles/ACLRole.php';
    //         // date_default_timezone_set('Asia/Kolkata');

    //         // $this->logger->log('debug', 'Inside data sync');
    //         // //fwrite($myfile,"\nInside data sync\n");
    //         // if(empty($bean->name)){
    //         //     if(!empty($bean->description)){
    //         //         $bean->name = substr($bean->description,0, 50);
    ...
    //         //     }
    //         // }
    //         // $this->logger->log('debug', "Saving case $bean->id");
    ...
    //         // $attended_by_c = $bean->attended_by_c;
    //         // $this->logger->log('debug', "start attended_by_c  $attended_by_c");
    ...
    //                 $bean->update_text = htmlentities(htmlspecialchars($bean->update_text));
    //             }
    //             $this->logger->log('debug', "Assigned user id before save $bean->assigned_user_id");
    ...
    //                 $auditid=create_guid();
    //                 $created_by=$current_user->id;
    //                 $this->logger->log('debug', "Auditid: $auditid  created_by: $created_by Date: $date");

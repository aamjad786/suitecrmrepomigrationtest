...
class DataSync{
    ...
    public function tempCategoryStore($bean){
        ...
        if($bean->case_category_c != $_REQUEST['case_category_c'] || $bean->case_subcategory_c != $_REQUEST['case_subcategory_c']){
            if(!empty($_REQUEST['case_category_c']) && !empty($_REQUEST['case_subcategory_c'])){
                #print_r($_REQUEST['case_category_c_new_c']);exit;
                $case_id = $_REQUEST['record'];
                $new_case_category = $_REQUEST['case_category_c'];
                $new_case_sub_category = $_REQUEST['case_subcategory_c'];

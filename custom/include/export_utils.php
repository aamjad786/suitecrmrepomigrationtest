...
function export($type, $records = null, $members = false, $sample=false)
{
    ...
    $GLOBALS['log']->fatal("Create export query cases results-> " . var_export($result, true));

    $fields_array = $db->getFieldsArray($result, true);

    $GLOBALS['log']->fatal("Create export query cases fields_array before -> " . var_export($fields_array, true));

    //set up the order on the header row
    $fields_array = get_field_order_mapping($focus->module_dir, $fields_array);

    $GLOBALS['log']->fatal("Create export query cases fields_array-> " . var_export($fields_array, true));
...
function get_field_order_mapping($name='', $reorderArr = '', $exclude = true)
{
    ...
    $field_order_array['cases'] =array( 
        'name' =>'Subject', 
        'assigned_user' =>'Assigned User',
        'department' =>'Assigned User Department',
        'case_number' =>'Case Number',
        'merchant_app_id_c' =>'Merchant App id',
        'merchant_contact_number_c' =>'Merchant Contact Number',
        'merchant_email_id_c' =>'Merchant Email id',
        'merchant_establisment_c' =>'Merchant Establisment',
        'merchant_name_c' =>'Merchant Name',
        'case_location_c' =>'Location',
        'resolution' =>'Resolution',
        'attended_by_c' =>'Case Owner',
        'complaintaint_c' =>'Complainant',
        'date_attended_c' =>'Date Attended',
        'date_resolved_c' =>'Date Resolved',
        'case_source_c' =>'Source',
        'case_sub_source_c' =>'Sub Source',
        'case_category_c' =>'Case Category',
        'case_subcategory_c' =>'Case Subcategory',
        'case_details' =>'Case Details',
        'age_c' =>'Age',
        'type' =>'Type',
        'sub_priority' =>'Escalataion Source',
        'priority' =>'Priority',
        'case_action_code_c' =>'Action Code',
        'state' =>'Status',
        'closed_by' =>'Closed By',
        'escalation_level_c' =>'Escalataion Level',
        'Service Manager' =>'Service Manager',
        'cases.date_entered' =>'Date Created',
        'cases.date_modified' =>'Date Modified',
        'cases.id' => 'id',
    );
                ...
                //if module is of type Sale
                    ...
                    if ($focus instanceof Sale) {
                        ...
                        if ($focus instanceof Issue) {
                            $name = 'bugs';
                        }//if module is of type Neo_Customers (Master Data)
                        else if ($focus instanceof Neo_Customers){
                            $name = 'Neo_Customers';
                        }//if module is of type Cases
                        else if ($focus instanceof Cases){
                            $name = 'Cases';
                        }//if module is of type File
                        else {
                            $name = 'Notes';

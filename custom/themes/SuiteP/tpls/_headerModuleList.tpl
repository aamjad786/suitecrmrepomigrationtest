...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        ...
        <!--<br/><br/>
        <div style="margin-bottom:5px;"><a href="?module=scrm_Custom_Reports&action=SendSms" target="_blank">Send SMS</a></div>
        <div style="margin-bottom:5px;"><a href="?module=scrm_Custom_Reports&action=AssignUser" target="_blank">User Management</a></div>
        <div style="margin-bottom:5px;"><a href="?module=scrm_Cases&action=CaseEscalationMatrix" target="_blank">Case Escalation Schedule</a></div>
        <div style="margin-bottom:5px;"><a href="?module=Leads&action=Month_sales_report" target="_blank">Sales Dashboard</a></div>
        <div style="margin-bottom:5px;"><a href="?module=Leads&action=sales_dashboard" target="_blank">Sales Dashboard 2</a></div>
        <div style="margin-bottom:5px;"><a href="?module=Leads&action=visits_dashboard" target="_blank">Visits Dashboard</a></div>
        <div style="margin-bottom:5px;"><a href="?module=Cases&action=customer_application_profile" target="_blank">Customer Application Profile</a></div>
        <div><a href="?module=Cases&action=NeoDepartments">Rewards & Recognition</a></div>-->

        <div class="desktop-toolbar" id="toolbar">
            {if $USE_GROUP_TABS}
                <ul class="nav navbar-nav">
                    <li class="navbar-brand-container">
                            <a class="navbar-brand with-home-icon suitepicon suitepicon-action-home" href="index.php?module=Home&action=index"> NeoGrowth Credit Pvt.Ltd.</a>
                    </li>
    ...
    <div id='sidebar_container' class="container-fluid sidebar_container">
        ...
        <div {if $smarty.cookies.sidebartoggle|default:'' == 'collapsed'}style="display:none"{/if}
             class="sidebar">
                ...
                <div class="recentlyViewedSidebar">
                    <ul class="nav nav-pills nav-stacked">
                        <div class="recently_viewed_link_container_sidebar">
                            <br/>
                            <li class="recentlinks" role="presentation">
                                <a href="?module=scrm_Custom_Reports&action=SendSms"
                                    class="recent-links-detail" target="_blank">
                                    <span>Send SMS</span>
                                </a>
                            </li>
                            <li class="recentlinks" role="presentation">
                                <a href="?module=scrm_Custom_Reports&action=AssignUser"
                                    class="recent-links-detail" target="_blank">
                                    <span>User Management</span>
                                </a>
                            </li>
                            <li class="recentlinks" role="presentation">
                                <a href="?module=scrm_Cases&action=CaseEscalationMatrix"
                                    class="recent-links-detail" target="_blank">
                                    <span>Case Escalation Schedule</span>
                                </a>
                            </li>
                            <li class="recentlinks" role="presentation">
                                <a href="?module=Leads&action=Month_sales_report"
                                    class="recent-links-detail" target="_blank">
                                    <span>Sales Dashboard</span>
                                </a>
                            </li>
                            <li class="recentlinks" role="presentation">
                                <a href="?module=Leads&action=sales_dashboard"
                                    class="recent-links-detail" target="_blank">
                                    <span>Sales Dashboard 2</span>
                                </a>
                            </li>
                            <li class="recentlinks" role="presentation">
                                <a href="?module=Leads&action=visits_dashboard"
                                    class="recent-links-detail" target="_blank">
                                    <span>VIsits Dashboard</span>
                                </a>
                            </li>
                            <li class="recentlinks" role="presentation">
                            ...
                            <li class="recentlinks" role="presentation">
                                <a href="?module=Cases&action=NeoDepartments"
                                    class="recent-links-detail" target="_blank">
